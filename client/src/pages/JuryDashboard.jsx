...
import { Gavel, Clock, Users, RefreshCw } from 'lucide-react';
...
export function JuryDashboard() {
  ...
  const loadDisputes = async () => {
    try {
      ...
      // Get all dispute cases from localStorage (in a real app, this would query a database or blockchain)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <NBCard className="text-center p-6">
            ...
            <div className="font-display font-bold text-2xl text-nb-ink">0</div>
