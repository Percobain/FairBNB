        ...
        try {
            ...
            for (const nft of result.nfts) {
                try {
                    ...
                    console.error(
                        `Failed to process NFT ${nft.tokenId}:`,
                        error
                    );
            ...
            // Calculate stats
            const activeRentals = processedProperties.filter(
                (p) => p.isRented
            ).length;
            const disputedRentals = processedProperties.filter(
                (p) => p.isDisputed
            ).length;
            const completedRentals = processedProperties.filter(
                (p) =>
                    !p.isRented &&
                    p.rental.tenant !==
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                    <div>
                        ...
                        <p className="font-body text-nb-ink/70">
                            Manage your blockchain properties and track rental
                            performance
                        </p>
                    </div>
                    <div className="flex items-center space-x-3 mt-4 sm:mt-0">
                    ...
                    {refreshing ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="font-body text-nb-ink/70 mb-6">
                                Create your first property NFT to start earning
                                rental income
                            </p>
                            <Link to="/landlord/new">
                                <NBButton
                                    ...
                                    >
                                        <div className="flex items-center space-x-4">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    e.target.src =
                                                        "/mock-images/placeholder-property.jpg";
                                                }}
                                            />
                                            <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <span
                                                className={`px-2 py-1 text-xs rounded border border-nb-ink ${
                                                    property.isListed
                                                        ? "bg-nb-accent text-nb-ink"
                                                        : "bg-nb-bg text-nb-ink/70"
                                                }`}
                                            >
                                                {property.status}
                                            </span>
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-nb-ink/50 font-mono text-xs">
                                    {web3Service.getAccount()?.slice(0, 6)}...
                                    {web3Service.getAccount()?.slice(-4)}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
